...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		{
			echo '<tbody class="content" id="category_', $category['id'], '_boards">';
			...
			foreach ($category['boards'] as $board)
			{
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="stats windowbg">
						<p>', comma_format($board['posts']), '
						</p>	
					</td>
					<td class="stats windowbg">
						<p>', comma_format($board['topics']), '
						</p>
					</td>
					<td class="lastpost">';
...
function template_info_center()
{
		...
		echo '
			...
			<table class="table_list">
				<tbody class="infocenter">
					<tr>
						<td class="icon windowbg"><a href="', $scripturl, '?action=recent"><img class="icon" src="', $settings['images_url'], '/post/xx.gif" alt="', $txt['recent_posts'], '" /></a></td>
						<td class="lastpost">
	...
	/*echo '
			...
			<table class="table_list">
				<tbody class="infocenter">
					<tr>
						<td class="icon windowbg">
							<a href="', $scripturl, '?action=mlist' . '"><img class="icon" src="', $settings['images_url'], '/icons/members.png', '" alt="', $txt['members'], '" /></a>
						</td>
						<td class="lastpost">
							<p>
								<strong>
									<a href="', $scripturl, '?action=mlist' . '">', $txt['members_list'], '</a>
								</strong>
								<br />
				...
				<tbody class="infocenter">
					<tr>
						...
						<td class="lastpost" valign="top" width="60%">
							<p class="smalltext">', $txt['total_topics'], ': <strong>', $context['common_stats']['total_topics'], '</strong>&nbsp;&nbsp;&nbsp;&nbsp;', $txt['total_posts'], ': <strong>', $context['common_stats']['total_posts'], '</strong><br />
						...
						<td class="lastpost" valign="top" width="auto">
							<p class="smalltext">', $txt['total_members'], ': <strong>', $context['common_stats']['total_members'], '</strong><br />
	...
	echo $context['show_who'] ? '</a>' : '',
			'&nbsp;<span style="font-size: 80%">', sprintf($txt['users_active'], $modSettings['lastActive']), ':</span>
			</p>
			<p class="inline smalltext" style="padding-top: 0; padding-bottom: 0">';
	...
	echo '		</p>
			<p class="inline smalltext" style="padding-top: 0">
				<a href="' . $scripturl . '?action=stats">' . $txt['more_stats'] . '</a>
				<a href="', $scripturl, '?action=mlist' . '">[', $txt['members_list'], ']</a>
			</p>',
