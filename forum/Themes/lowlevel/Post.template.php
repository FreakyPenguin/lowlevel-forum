...
function template_main()
{
	...
	{
		echo '
					<p class="information" id="approved_warning">
	...
	if (isset($context['previous_posts']) && count($context['previous_posts']) > 0)
	{
		...
		foreach ($context['previous_posts'] as $post)
		{
			...
			if ($context['can_quote'])
			{
				$quote_button = create_buttons('quote.png', 'bbc_quote', 'bbc_quote', 'align="middle"');
				echo '
					<ul class="reset smalltext quickbuttons', $settings['use_image_buttons'] == 2 ? '2' : '', '" id="msg_', $post['id'], '_quote">
						<li class="quote_button"><a href="#postmodify" onclick="return insertQuoteFast(', $post['id'], ');">', $quote_button, '</a></li>
					</ul>';
			}
