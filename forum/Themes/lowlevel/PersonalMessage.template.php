...
<form class="flow_hidden" action="', $scripturl, '?action=pm;sa=pmactions;', $context['display_mode'] == 2 ? 'conversation;' : '', 'f=', $context['folder'], ';start=', $context['start'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', '" method="post" accept-charset="', $context['character_set'], '" name="pmFolder">';
	...
	if ($context['get_pmessage']('message', true))
	{
		...
		if ($context['display_mode'] == 2)
		{
			...
			$conversation_buttons = array(
				'im_reply_all' => array('text' => 'reply_to_all', 'image' => 'im_reply_all.png', 'lang' => true, 'url' => $scripturl . '?action=pm;sa=send;f=' . $context['folder'] . ($context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '') . ';pmsg=' . $context['current_pm'] . ';u=all', 'active' => true),
				'im_delete_conversation' => array('text' => 'delete_conversation', 'image' => 'delete.png', 'lang' => true, 'url' => $scripturl . '?action=pm;sa=pmactions;pm_actions[' . $context['current_pm'] . ']=delete;conversation;f=' . $context['folder'] . ';start=' . $context['start'] . ($context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '') . ';' . $context['session_var'] . '=' . $context['session_id'], 'custom' => 'onclick="return confirm(\'' . addslashes($txt['remove_message']) . '?\');"'),
			);
	...
	<div class="', $window_class, ' clear">
		<span class="topslice', $context['display_mode'] == 1 ? '2' : '', '"><span></span></span>
		<div class="poster">
		...
		<div class="postarea">
			...
			if ($context['can_send_pm'])
			{
				...
				if (!$message['member']['is_guest'])
				{
					...
					$reply_button = create_buttons('im_reply.png', 'reply', 'reply', 'align="middle"');
					$quote_button = create_buttons('im_quote.png', 'quote', 'quote', 'align="middle"');					
					// Is there than more than one recipient you can reply to?
					if ($message['number_recipients'] > 1 && $context['display_mode'] != 2)
					{
						$reply_all_button = create_buttons('im_reply_all.png', 'reply_to_all', 'reply_to_all', 'align="middle"');
						echo '
					<li class="reply_all_button"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote;u=all">', $reply_all_button, '</a></li>';
					}

					echo '
					<li class="reply_button"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';u=', $message['member']['id'], '">', $reply_button, '</a></li>
					<li class="quote_button"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote', $context['folder'] == 'sent' ? '' : ';u=' . $message['member']['id'], '">', $quote_button, '</a></li>';
				}
				// This is for "forwarding" - even if the member is gone.
				else
				{
					$forward_button = create_buttons('im_quote.png', 'reply_quote', 'reply_quote', 'align="middle"');
					echo '
					<li class="forward_button"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote">', $forward_button, '</a></li>';
				}
			}

			$remove_button = create_buttons('im_delete.png', 'delete', 'delete', 'align="middle"');
			echo '
					<li class="remove_button"><a href="', $scripturl, '?action=pm;sa=pmactions;pm_actions[', $message['id'], ']=delete;f=', $context['folder'], ';start=', $context['start'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';', $context['session_var'], '=', $context['session_id'], '" onclick="return confirm(\'', addslashes($txt['remove_message']), '?\');">', $remove_button, '</a></li>';
...
function template_search_results()
{
	...
	echo '
		...
		<div class="pagesection', !empty($context['personal_messages']) ? '_top' : '', '">
	...
	foreach ($context['personal_messages'] as $message)
	{
		...
		if (!empty($context['search_params']['show_complete']))
		{
			...
			<div class="windowbg', $alternate ? '2': '', '">
				...
				if ($context['can_send_pm'])
				{
					$quote_button = create_buttons('im_quote.png', 'reply_quote', 'reply_quote', 'align="middle"');
					$reply_button = create_buttons('im_reply.png', 'reply', 'reply', 'align="middle"');
					...
					if (!$message['member']['is_guest'])
						echo '
								<li class="quote_button"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';quote;u=', $context['folder'] == 'sent' ? '' : $message['member']['id'], '">', $quote_button , '</a>', '</li>
								<li class="reply_button"><a href="', $scripturl, '?action=pm;sa=send;f=', $context['folder'], $context['current_label_id'] != -1 ? ';l=' . $context['current_label_id'] : '', ';pmsg=', $message['id'], ';u=', $message['member']['id'], '">', $reply_button , '</a> ', '</li>';
					// This is for "forwarding" - even if the member is gone.
					else
						echo '
