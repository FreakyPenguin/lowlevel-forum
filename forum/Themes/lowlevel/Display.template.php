...
function template_main()
{
	...
	if ($context['is_poll'])
	{
		...
		$poll_buttons = array(
			...
			'lock_poll' => array('test' => 'allow_lock_poll', 'text' => (!$context['poll']['is_locked'] ? 'poll_lock' : 'poll_unlock'), 'image' => 'poll_lock.gif', 'lang' => true, 'url' => $scripturl . '?action=lockvoting;topic=' . $context['current_topic'] . '.' . $context['start'] . ';' . $context['session_var'] . '=' . $context['session_id']),
			'edit_poll' => array('test' => 'allow_edit_poll', 'text' => 'poll_edit', 'image' => 'poll_edit.gif', 'lang' => true, 'url' => $scripturl . '?action=editpoll;topic=' . $context['current_topic'] . '.' . $context['start']),
	...
	$normal_buttons = array(
		'reply' => array('test' => 'can_reply', 'text' => 'reply', 'image' => 'reply.png', 'lang' => true, 'url' => $scripturl . '?action=post;topic=' . $context['current_topic'] . '.' . $context['start'] . ';last_msg=' . $context['topic_last_message']),
		...
		'send' => array('test' => 'can_send_topic', 'text' => 'send_topic', 'image' => 'send.png', 'lang' => true, 'url' => $scripturl . '?action=emailuser;sa=sendtopic;topic=' . $context['current_topic'] . '.0'),
	...
	echo '
			...
			<div class="pagesection_top">
				...
				<div class="pagelinks floatleft">', $txt['pages'], ': ', $context['page_index'], '
				</div>', !empty($modSettings['topbottomEnable']) ? '&nbsp;&nbsp;
				<div class="go_down smalltext"><a href="#lastPost"><span><strong>' . $txt['go_down'] . '</strong></span></a></div>' : '', '</div>';
	...
	while ($message = $context['get_message']())
	{
		...
		if (!empty($modSettings['onlineEnable']) && !$message['member']['is_guest'])
			...
			if (!empty($message['member']['custom_fields']) && $message['member']['can_view_profile'] && $message['member']['has_messenger'])
			{
				$shown = false;
		...
		if ($context['can_moderate_forum'] && !empty($message['member']['ip2']))
			echo '
								<a href="', $scripturl, '?action=', !empty($message['member']['is_guest']) ? 'trackip' : 'profile;area=tracking;sa=ip;u=' . $message['member']['id2'], ';searchip=', $message['member']['ip2'], '">', $message['member']['ip2'], '</a>';
						...
						<div class="postarea">
							<div class="flow_hidden">
								<div class="keyinfo">
									...
									<div class="posttile"><h5 id="subject_', $message['id'], '">
		...
		if ($message['can_approve'] || $context['can_reply'] || $message['can_modify'] || $message['can_remove'] || $context['can_split'] || $context['can_restore_msg'])
			echo '
								<ul class="reset smalltext quickbuttons', $settings['use_image_buttons'] == 2 ? '2' : '', '">';

		// Create the buttons!
		$approve_button = create_buttons('approve.png', 'approve', 'approve', 'align="middle"');

		// Maybe we can approve it, maybe we should?
		if ($message['can_approve'])
			echo '
									<li class="approve_button"><a href="', $scripturl, '?action=moderate;area=postmod;sa=approve;topic=', $context['current_topic'], '.', $context['start'], ';msg=', $message['id'], ';', $context['session_var'], '=', $context['session_id'], '">', $approve_button, '</a></li>';

		// Can they reply? Have they turned on quick reply?
		if ($context['can_quote'] && !empty($options['display_quick_reply']))
		{
			$quote_button = create_buttons('quote.png', 'quote', 'quote', 'align="middle"');
			echo '
									<li class="quote_button"><a href="', $scripturl, '?action=post;quote=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';last_msg=', $context['topic_last_message'], '" onclick="return oQuickReply.quote(', $message['id'], ');">', $quote_button, '</a></li>';
		...
		} elseif ($context['can_quote'])
		{
			$quote_button = create_buttons('quote.png', 'quote', 'quote', 'align="middle"');
			echo '
									<li class="quote_button"><a href="', $scripturl, '?action=post;quote=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';last_msg=', $context['topic_last_message'], '">', $quote_button, '</a></li>';
		}

		// Can the user modify the contents of this post?
		if ($message['can_modify'])
		{
			$modify_button = create_buttons('modify.png', 'modify', 'modify', 'align="middle"');
			echo '
									<li class="modify_button"><a href="', $scripturl, '?action=post;msg=', $message['id'], ';topic=', $context['current_topic'], '.', $context['start'], '">', $modify_button, '</a></li>';
		}

		// How about... even... remove it entirely?!
		if ($message['can_remove'])
		{
			$remove_button = create_buttons('delete.png', 'remove', 'remove', 'align="middle"');
			echo '
									<li class="remove_button"><a href="', $scripturl, '?action=deletemsg;topic=', $context['current_topic'], '.', $context['start'], ';msg=', $message['id'], ';', $context['session_var'], '=', $context['session_id'], '" onclick="return confirm(\'', $txt['remove_message'], '?\');">', $remove_button, '</a></li>';
		}

		// What about splitting it off the rest of the topic?
		if ($context['can_split'] && !empty($context['real_num_replies']))
		{
			$split_button = create_buttons('split.png', 'split', 'split', 'align="middle"');
			echo '
									<li class="split_button"><a href="', $scripturl, '?action=splittopics;topic=', $context['current_topic'], '.0;at=', $message['id'], '">', $split_button, '</a></li>';
		}

		// Can we restore topics?
		if ($context['can_restore_msg'])
		{
			$restore_button = create_buttons('restore_topic.gif', 'restore_message', 'restore_message', 'align="middle"');
			echo '
									<li class="restore_button"><a href="', $scripturl, '?action=restoretopic;msgs=', $message['id'], ';', $context['session_var'], '=', $context['session_id'], '">', $restore_button, '</a></li>';
		}
	...
	echo '
			<div class="pagesection_bottom">
				...
				<div class="go_up smalltext"><a href="#top"><span><strong>' . $txt['go_up'] . '</strong></span></a></div>' : '', '</div>
