...
function template_main()
{
	...
	foreach ($context['posts'] as $post)
	{
		...
		if ($post['can_reply'])
			echo '
						<li class="reply_button"><a href="', $scripturl, '?action=post;topic=', $post['topic'], '.', $post['start'], '"><span><img src="' . $settings['images_url'] . '/buttons/reply.png" alt="', $txt['reply'], '" title="', $txt['reply'], '" />', $txt['reply'], '</span></a></li>';

		// If they *can* quote?
		if ($post['can_quote'])
			echo '
						<li class="quote_button"><a href="', $scripturl, '?action=post;topic=', $post['topic'], '.', $post['start'], ';quote=', $post['id'], '"><span><img src="' . $settings['images_url'] . '/buttons/quote.png" alt="', $txt['quote'], '" title="', $txt['quote'], '" />', $txt['quote'], '</span></a></li>';

		// Can we request notification of topics?
		if ($post['can_mark_notify'])
			echo '
						<li class="notify_button"><a href="', $scripturl, '?action=notify;topic=', $post['topic'], '.', $post['start'], '"><span><img src="' . $settings['images_url'] . '/buttons/notify.png" alt="', $txt['notify'], '" title="', $txt['notify'], '" />', $txt['notify'], '</span></a></li>';

		// How about... even... remove it entirely?!
		if ($post['can_delete'])
			echo '
						<li class="remove_button"><a href="', $scripturl, '?action=deletemsg;msg=', $post['id'], ';topic=', $post['topic'], ';recent;', $context['session_var'], '=', $context['session_id'], '" onclick="return confirm(\'', $txt['remove_message'], '?\');"><span><img src="' . $settings['images_url'] . '/buttons/delete.png" alt="', $txt['remove'], '" title="', $txt['remove'], '" />', $txt['remove'], '</span></a></li>';
...
function template_unread()
{
	...
	if (!empty($context['topics']))
	{
		...
		echo '
			...
			<div class="pagesection_bottom" id="readbuttons">';
