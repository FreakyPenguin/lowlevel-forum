...
function template_main()
{
	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		<table class="table_list" cellspacing="0">
			...
			<tr>
				<td colspan="2">', $txt['parent_boards'], '</td>
				<td class="stats">', $txt['posts'], '</td>
				<td class="stats">', $txt['board_topics'], '</td>
				<td>', $txt['last_post'], '</td>
			</tr>
			</tbody>
		...
		{
			echo '				<tr id="board_', $board['id'], '" class="windowbg2">
			...
			echo '
					...
					<td class="stats windowbg"', $board['is_redirect'] ? ' colspan="2"' : '',  '>
						<p>', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : '', '
						</p>
					</td>';
			...
			if (!empty($board['last_post']['id']))
				echo '
						<p>', $board['last_post']['time'], '
							<br />', $txt['in'], ' ', $board['last_post']['link'], '
							<br />', $txt['by'], ' ', $board['last_post']['member']['link'] , '
						</p>';
	...
	<div class="pagesection_top">
		<div class="pagelinks floatleft">', $txt['pages'], ': ', $context['page_index'], '</div>', !empty($modSettings['topbottomEnable']) ? '<div class="go_down smalltext"><a href="#bot"><span><strong>' . $txt['go_down'] . '</strong></span></a></div>' : '', '
	...
	<div class="tborder topic_table" id="messageindex">
		...
		if (!empty($context['topics']))
		{
			echo '
					...
					<th scope="col" class="smalltext center" width="7%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=views', $context['sort_by'] == 'views' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['views'], $context['sort_by'] == 'views' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			// Show a "select all" box for quick moderation?
			if (empty($context['can_quick_mod']))
				echo '
					<th scope="col" class="lefttext last_th" width="160px"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
			else
				echo '
					<th scope="col" class="lefttext" width="160px"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>';
	...
	<div class="pagesection_bottom">
		<div class="pagelinks floatleft">', $txt['pages'], ': ', $context['page_index'], '</div>', !empty($modSettings['topbottomEnable']) ? '<div class="go_up smalltext"><a href="#top"><span><strong>' . $txt['go_up'] . '</strong></span></a></div>' : '', '
		', template_button_strip($normal_buttons, 'right'), '
	</div>';
	}
