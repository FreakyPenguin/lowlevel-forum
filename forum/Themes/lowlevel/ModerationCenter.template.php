...
function template_reported_posts()
{
	...
	// Make the buttons.
	$close_button = create_buttons('close.png', $context['view_closed'] ? 'mc_reportedp_open' : 'mc_reportedp_close', $context['view_closed'] ? 'mc_reportedp_open' : 'mc_reportedp_close', 'align="middle"');
	$details_button = create_buttons('details.png', 'mc_reportedp_details', 'mc_reportedp_details', 'align="middle"');
	$ignore_button = create_buttons('ignore.png', 'mc_reportedp_ignore', 'mc_reportedp_ignore', 'align="middle"');
	$unignore_button = create_buttons('unignore.png', 'mc_reportedp_unignore', 'mc_reportedp_unignore', 'align="middle"');
				...
				<div>
					...
					<div class="floatright">
						<ul class="reset smalltext quickbuttons', $settings['use_image_buttons'] == 2 ? '2' : '', '">
							<li class="report_details_button"><a href="', $report['report_href'], '">'. $details_button, '</a></li>
							<li class="report_ignore_button"><a href="', $scripturl, '?action=moderate;area=reports', $context['view_closed'] ? ';sa=closed' : '', ';ignore=', (int) !$report['ignore'], ';rid=', $report['id'], ';start=', $context['start'], ';', $context['session_var'], '=', $context['session_id'], '" ', !$report['ignore'] ? 'onclick="return confirm(\'' . $txt['mc_reportedp_ignore_confirm'] . '\');"' : '', '>', $report['ignore'] ? $unignore_button : $ignore_button, '</a></li>
							<li class="report_close_button"><a href="', $scripturl, '?action=moderate;area=reports', $context['view_closed'] ? ';sa=closed' : '', ';close=', (int) !$report['closed'], ';rid=', $report['id'], ';start=', $context['start'], ';', $context['session_var'], '=', $context['session_id'], '">', $close_button, '</a></li>
						', !$context['view_closed'] ? '<li class="inline_mod_check"><input type="checkbox" name="close[]" value="' . $report['id'] . '" class="input_check" /></li>' : '', '
						</ul>
					</div>
				</div><br />
				<div class="smalltext">
...
function template_unapproved_posts()
{
	...
	$remove_button = create_buttons('delete.png', 'remove_message', 'remove', 'align="middle"');
	...
	foreach ($context['unapproved_items'] as $item)
	{
		...
		<div class="cat_bar">
			<h3 class="catbg">
				<span class="smalltext floatleft counter2">', $item['counter'], '&nbsp;</span>
		...
		<div class="', $item['alternate'] ? 'windowbg' : 'windowbg2', '">
			...
			<div class="content">
				...
				<div class="overflow_auto">
					<ul class="reset smalltext quickbuttons', $settings['use_image_buttons'] == 2 ? '2' : '', '">
						<li class="approve_button"><a href="', $scripturl, '?action=moderate;area=postmod;sa=', $context['current_view'], ';start=', $context['start'], ';', $context['session_var'], '=', $context['session_id'], ';approve=', $item['id'], '">', $approve_button, '</a></li>';

			if ($item['can_delete'])
				echo '
						<li class="remove_button"><a href="', $scripturl, '?action=moderate;area=postmod;sa=', $context['current_view'], ';start=', $context['start'], ';', $context['session_var'], '=', $context['session_id'], ';delete=', $item['id'], '">', $remove_button, '</a></li>';

			echo '
						<li class="inline_mod_check"><input type="checkbox" name="item[]" value="', $item['id'], '" checked="checked" class="input_check" /></li>
					</ul>';
...
function template_viewmodreport()
{
	...
	<div id="modcenter">
		...
		// Make the buttons.
		$close_button = create_buttons('close.png', $context['report']['closed'] ? 'mc_reportedp_open' : 'mc_reportedp_close', $context['report']['closed'] ? 'mc_reportedp_open' : 'mc_reportedp_close', 'align="middle"');
		$ignore_button = create_buttons('ignore.png', 'mc_reportedp_ignore', 'mc_reportedp_ignore', 'align="middle"');
		$unignore_button = create_buttons('ignore.png', 'mc_reportedp_unignore', 'mc_reportedp_unignore', 'align="middle"');

		echo '
						<ul class="reset smalltext quickbuttons', $settings['use_image_buttons'] == 2 ? '2' : '', '">
							<li class="ignore_button"><a href="', $scripturl, '?action=moderate;area=reports;ignore=', (int) !$context['report']['ignore'], ';rid=', $context['report']['id'], ';', $context['session_var'], '=', $context['session_id'], '" ', !$context['report']['ignore'] ? 'onclick="return confirm(\'' . $txt['mc_reportedp_ignore_confirm'] . '\');"' : '', '>', $context['report']['ignore'] ? $unignore_button : $ignore_button, '</a></li>
							<li class="close_button"><a href="', $scripturl, '?action=moderate;area=reports;close=', (int) !$context['report']['closed'], ';rid=', $context['report']['id'], ';', $context['session_var'], '=', $context['session_id'], '">', $close_button, '</a></li>
						</ul>
					</span>
				</h3>
			</div>
...
{
	global $scripturl, $context, $txt, $delete_button, $settings;

	// We'll have a delete please bob.
	if (empty($delete_button))
		$delete_button = create_buttons('delete.png', 'remove_message', 'remove', 'align="middle"');
	...
	if ($post['can_delete'])
	{
		$output_html .= '
							<ul class="reset smalltext quickbuttons'. ($settings['use_image_buttons'] == 2 ? '2' : ''). '">
								<li class="remove_button"><a href="' . $scripturl . '?action=moderate;area=userwatch;sa=post;delete=' . $post['id'] . ';start=' . $context['start'] . ';' . $context['session_var'] . '=' . $context['session_id'] . '" onclick="return confirm(\'' . $txt['mc_watched_users_delete_post'] . '\');">' . $delete_button . '</a></li>
							<li class="inline_mod_check"><input type="checkbox" name="delete[]" value="' . $post['id'] . '" class="input_check" /></li>
						</ul>';
	}
...
function template_moderation_settings()
{
	...
	<div id="modcenter">
		<form action="', $scripturl, '?action=moderate;area=settings" method="post" accept-charset="', $context['character_set'], '">
			...
			<div class="windowbg2">
				<span class="topslice2"><span></span></span>
				<div class="content">
					<dl class="settings">
						<dt>
