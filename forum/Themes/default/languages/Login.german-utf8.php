...
$txt['activate_after_registration'] = 'Danke für die Registrierung. Sie werden in Kürze eine E-Mail erhalten, mit der Sie Ihr Benutzerkonto aktivieren können. Sollten Sie nach einiger Zeit keine E-Mail erhalten haben, prüfen Sie bitte Ihren Spam-Ordner.<br /><br />Sollte die E-Mail überhaupt nicht ankommen, kannst Du versuchen in unserem Chat (auf dem IRC-Server irc.euirc.net im Channel #lost) mit uns Kontakt aufzunehmen. Häufig ist jemand anzutreffen, der Dir weiterhelfen kann. Wenn Du keinen IRC-Client hast, kannst Du den <a href="http://chat.mibbit.com/?channel=%23lost&server=irc.euirc.net">Webchat</a> verwenden.';
