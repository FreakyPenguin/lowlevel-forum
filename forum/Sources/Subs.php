		...
		*/
		...
		$codes = array(
			...
			array(
				...
				'validate' => create_function('&$tag, &$data, $disabled', '
					if (strpos($data, \'http://\') !== 0 && strpos($data, \'https://\') !== 0)
						$data = \'http://\' . $data;
				'),
				'disallow_children' => array('email', 'ftp', 'url', 'iurl', 'wiki'),
				'disabled_after' => ' ($1)',
			),
			array(
				'tag' => 'white',
			...
			array(
				'tag' => 'wiki',
				'type' => 'unparsed_equals',
				'before' => '<a href="http://www.lowlevel.eu/wiki/$1" class="bbc_link" target="_blank">',
				'after' => '</a>',
				'disallow_children' => array('email', 'ftp', 'url', 'iurl', 'wiki'),
				'disabled_after' => ' ($1)',
			),
...
function setupMenuContext()
{
	...
	if (($menu_buttons = cache_get_data('menu_buttons-' . implode('_', $user_info['groups']) . '-' . $user_info['language'], $cacheTime)) === null || time() - $cacheTime <= $modSettings['settings_updated'])
	{
		$buttons = array(
			...
			'wiki' => array(
				'title' => 'Wiki',
				'href' => 'http://www.lowlevel.eu/wiki/Hauptseite',
				'show' => true,
				'sub_buttons' => array(
				),
			),
